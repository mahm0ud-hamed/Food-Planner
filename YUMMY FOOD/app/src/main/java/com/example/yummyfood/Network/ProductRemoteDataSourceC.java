...
public class ProductRemoteDataSourceC{
    ...
    private static ProductRemoteDataSourceC productClient = null ;

    private  ProductServiceConetion productService ;
    ...
    private ProductRemoteDataSourceC(){
        ...
        Retrofit retrofit = new Retrofit.Builder().baseUrl(baseUrl)
                ...
                .build();
        productService = retrofit.create(ProductServiceConetion.class);
    ...
    public static ProductRemoteDataSourceC getInstance(){
        ...
        if(productClient == null ){
            productClient = new ProductRemoteDataSourceC();
        }
    ...
    public void makeNetworkCall (NetWorkCallBack netWorkDelegate){
        ...
        Call<RanndomMealResponse> call = productService.getRandomMeal();
