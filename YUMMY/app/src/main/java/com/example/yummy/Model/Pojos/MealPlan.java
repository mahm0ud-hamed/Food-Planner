...
public class MealPlan extends MealDetails{
    ...
    public String getPlanDayDate() {
        return planDayDate;
    }

    public void setPlanDayDate(String dayName) {
        planDayDate = dayName ;
    }
