...
import com.example.yummy.ui.Srearch.IMealsListView;
import com.example.yummy.ui.Srearch.ISearchView;
...
public class RemoteDataPresenter implements IRemoteDataPresnetr, NetWorkCallBack {
    ...
    private IMealsListView mealsListView;
    private IMealDetail mealDetail;
